...
def run(
    ...
    expose: bool = typer.Option(
        False,
        "--expose",
        help="Expose server over the internet",
    ),
    domain: str = typer.Option(
        None,
        "--domain",
        help="Use `--expose` with a custom ngrok domain",
    ),
    client: str = typer.Option(
        None,
        "--client",
        help="Run client of a particular type. Accepts `light-python`, defaults to `light-python`",
    ),
    ...
    qr: bool = typer.Option(
        False,
        "--qr",
        help="Display QR code containing the server connection information (will be ngrok url if `--expose` is used)",
    ),
    ...
    profile: str = typer.Option(
        "default.py",          # ← FIXED: was None, which crashed
        "--profile",
    ...
    if server:
        ...
        if server == "livekit":
            ...
            # Import livekit modules only when needed
